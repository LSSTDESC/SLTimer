...
## desc-0000-sltimer-tdc2_gateway_analysis
# Estimating Time Delay Measurement Feasibility in TDC2

*Chun-Hao To, Phil Marsshall, Steve Kahn*
...
**https://github.com/DarkEnergyScienceCollaboration/SLTimer/tree/pdf/desc-0000-sltimer-tdc2_gateway_analysis.pdf**
...
3. Set the `GITHUB_API_KEY` environment variable with the value of this token at your repo's [travis settings page](https://travis-ci.org/DarkEnergyScienceCollaboration/SLTimer/settings).
